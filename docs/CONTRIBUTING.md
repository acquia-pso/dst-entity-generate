# Contributing to the Acquia Drupal Entity Generator
...
Before submitting an issue please check that the [issue database](https://github.com/acquia-pso/dst-entity-generate/issues) does not already contain the same problem or suggestion.
...
Pull requests are always welcome. Not sure if that typo is worth a pull request? Found a bug and know how to fix it? Do it! We appreciate the help. Any significant improvement should be documented as [a GitHub issue](https://github.com/acquia-pso/dst-entity-generate/issues) before starting working on it.
